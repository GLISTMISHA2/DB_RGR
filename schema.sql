...
CREATE TABLE sensors (
    ...
    type VARCHAR(50) NOT NULL CHECK (type IN ('temperature', 'humidity', 'co2', 'smoke', 'water_leak')),
    unit VARCHAR(20) NOT NULL,
    critical_high FLOAT NOT NULL CHECK (critical_high > 0),
...
CREATE TABLE relays (
    ...
    gpio_pin VARCHAR(10) NOT NULL UNIQUE,
    controller_id INT NOT NULL REFERENCES controllers(id) ON DELETE CASCADE
);
